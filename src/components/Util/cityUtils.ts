...
export const CITY_TYPE_OPTIONS = CITY_SIZE_OPTIONS.map((size) =>
  size === "unknown" ? "City - unknown" : `City - ${size}`,
);
...
const featureColors = {
  ...
  "Shanty Town(s)": "#795548", // Alternative plural form
  Temple: "#fb8c00",
  Walls: "#607d8b",
};
...
const featureIcons = {
  ...
  "Shanty Town(s)": ShantyTownIcon, // Alternative plural form
  Temple: TempleIcon,
  Walls: WallsIcon,
};
