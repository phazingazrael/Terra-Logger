...
import { religionAdapter } from "../../atlas/adapters/religionAdapter";
...
export const mutateReligions = async (
  ...
  for (const religion of data.religions) {
    ...
    console.log("newReligion.origins", newReligion.origins);

    newReligion.content = religionAdapter.createDefaultContent(newReligion);

    console.log("newReligion", newReligion);
    tempMap.religions.push(newReligion);
    console.log("tempMap.religions loop", tempMap.religions);
  }
  console.log("tempMap.religions", tempMap.religions);
