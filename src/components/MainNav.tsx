...
import { TiBook, TiCog, TiDocumentText, TiGlobe, TiHome, TiTags } from 'react-icons/ti';
              ...
              <AccordionDetails>
                <MenuList>
                  {mapList.map((map: MapInf) => {
                    return (
                      <MenuItem key={map.info.ID} onClick={() => handleMenuItemClick(map)}>
                        {map.info.name}
                      </MenuItem>
                    );
                  })}
