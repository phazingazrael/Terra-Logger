...
export type AtlasRelatedLookups = {
	citiesByCountryId?: Map<string, TLCity[]>;
	countriesByEntityId?: Map<string, TLCountry>;
	countriesByNumericId?: Map<number, TLCountry>;
	notesByNameAndType?: Map<string, TLNote>;
	tagsById?: Map<string, Tag>;
};

export type AtlasRenderContext<
	TSource extends AtlasSourceType = AtlasSourceType,
> = {
	sourceType: TSource;
	entity: AtlasEntityBySource[TSource];
	related?: AtlasRelatedEntities;
	relatedLookups?: AtlasRelatedLookups;
};
...
export type AtlasSectionPreset<
	TSource extends AtlasSourceType = AtlasSourceType,
> = {
	id: string;
	label: string;
