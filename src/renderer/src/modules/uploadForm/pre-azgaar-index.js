...
const UploadForm = () => {
    ...
    const readMAP = (e) => {
        ...
        fileReader.onloadend = function (e) {
            let Countries = JSON.parse(localStorage.getItem("TL_Map.countries"));
            let Cities = JSON.parse(localStorage.getItem("TL_Map.cities"));
            let Religions = JSON.parse(localStorage.getItem("TL_Map.religions"));
    ...
    function parseMap(data) {
        let cities = data[15].ARR;
        let countries = data[14].ARR;
        let provinces = data[30].ARR;
        let religions = data[29].ARR;
        let cultures = data[13].ARR;
        let nameBases = data[31].PSV;
        ...
        void (function parseCities() {
            ...
            cityArray.map((City) => {
                ...
                let country = TL_Map.countries[cityState];
                cityObj.country = {
                    name: country.name || "",
